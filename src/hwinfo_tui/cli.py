...
from .utils.units import suggest_sensor_names, validate_sensor_compatibility
...
def list_sensors(
    ...
    filter_unit: Optional[str] = typer.Option(
        None,
        "--unit", "-u",
    ...
    try:
        ...
        if len(available_sensors) > limit:
            ...
            console.print(f"[blue]Tip:[/blue] Use --limit to see more sensors")
